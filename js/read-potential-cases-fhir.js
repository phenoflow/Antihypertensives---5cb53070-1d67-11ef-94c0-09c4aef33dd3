...
(async () => {
  ...
  await fs.writeFile("antihypertensives-potential-cases.csv", "patient-id,dob,codes,last-encounter\n");
  for(let patient in patients) {
    try {
      ...
      await fs.appendFile("antihypertensives-potential-cases.csv", row);
    } catch(error) {
      console.log(error);
    }
  }
